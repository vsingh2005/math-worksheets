...
\noindent
Represent the addition problem on the provided number line, and then solve all computation problems. Show your steps clearly.
...
% ==========================================================
\begin{tcolorbox}[colback=customteal!20]
\large\textcolor{black}{\textbf{Part B: Real-World Contexts (Temperature, Elevation, \& Debt)}}
\end{tcolorbox}

\noindent
For each problem, write an addition or subtraction expression that represents the situation, and then solve. 
...
% ==========================================================
% PART C — MULTI-STEP & CONCEPTUAL PROBLEMS
% ==========================================================
\begin{tcolorbox}[colback=customteal!20]
\large\textcolor{black}{\textbf{Part C: Distance & Multi-Step Problems}}
\end{tcolorbox}

\noindent
Apply your understanding of rational number operations to solve the following conceptual problems.
