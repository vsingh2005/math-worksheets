...
\medskip
\textbf{1.} Explain the core concept behind Congruence & Sequences of Transformations in your own words.

\vspace{2cm}

\textbf{2.} How does the standard 8.G.A.2 apply to this topic?
...
\medskip
\textbf{3.} Provide a real-world example where you would need to use Congruence & Sequences of Transformations. Work out a sample problem.
