...
\begin{enumerate}[itemsep=5.5cm, leftmargin=0.6cm, resume]
\item A line of best fit is represented by the equation $y = 2.5x + 10$, where $x$ represents hours studied and $y$ represents test score. Predict the test score of a student who studied for 6 hours. \blank
\end{enumerate}
