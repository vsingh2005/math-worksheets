...
\textbf{Example:} Start with the ratio $\dfrac{2}{5}$
...
\textbf{Deeper Thinking Problem 1: Comparing Recipes}

\medskip

\noindent
Two recipes for juice:
\begin{itemize}
    \item Recipe A: 2 cups concentrate to 5 cups water
    \item Recipe B: 3 cups concentrate to 7 cups water
\end{itemize}

\noindent
\textbf{a)} Make a ratio table for each recipe with 4 columns.

\vspace{3cm}

\noindent
\textbf{b)} Which recipe has more concentrate? Show your work using the tables.
